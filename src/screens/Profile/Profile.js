...
import { View, Text, TouchableOpacity, Image, ActivityIndicator, ScrollView, StatusBar } from 'react-native';
...
const Profile = () => {
      ...
      >
        ...
        <SkeletonPlaceholder>
          <View style={{ padding: 10 }}>
            ...
            {data.map((_, index) => (
              <View key={index} style={{ backgroundColor: "white", margin: 5, marginHorizontal: 5, height: 60, justifyContent: "center", borderRadius: 5 }}>
                <View style={{ flexDirection: "row", justifyContent: "space-between", paddingHorizontal: 5 }}>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <View style={{ width: '100%', height: 50, borderRadius: 13, marginRight: 5 }} />
                  </View>
                </View>
              </View>
            ))}
  ...
  return (
    <View>
      <View style={{ marginTop: 5, marginHorizontal: 5, flexDirection: 'row', justifyContent: "space-between", paddingRight: 10 }}>
      ...
      <View style={{ marginBottom: 20, marginTop: 20 }}>
        <TouchableOpacity style={{ justifyContent: "center", alignItems: "center", borderRadius: 5 }}>
          <Image
            source={{ uri: token == null || picture == null ? 'https://picsum.photos/200' : `${Baseurl}/api/${picture}` }}
