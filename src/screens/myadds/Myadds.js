                  ...
                  <View
                    ...
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <AntDesign
                        ...
                        onPress={() =>
                          item.category == 'education'
                            ? navigation.navigate('Editeducationadds', {item})
                            : item.category == 'property'
                            ? navigation.navigate('Editpropertyadds', {item})
                            : item.category == 'vehicles'
                            ? navigation.navigate('Editvehicleads', {item})
                            : item.category == 'hospitality'
                            ? navigation.navigate('Edithospitalityadds', {item})
                            : item.category == 'doctors'
                            ? navigation.navigate('Editdoctoradds', {item})
                            : item.category == 'hospitals'
                            ? navigation.navigate('Edithospitaladds', {item})
                            : null
                        }
                      />
                    </View>
